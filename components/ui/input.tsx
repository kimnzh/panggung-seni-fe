  ...
  return (
    ...
    >
      ...
      <input
        ...
        data-slot="input"
        className={cn(
          "peer z-10 file:text-foreground placeholder:text-normal-gold/60 selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-light-gold w-full min-w-0 rounded-lg border-2 bg-transparent pl-11 group-data-[variant=default]:pl-5 pr-5 py-3 text-b8 shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-b7",
